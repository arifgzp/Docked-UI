...
import { customColors, customButton, customCheckboxIcon, customCheckboxIndicator } from "./CustomTheme";
...
export const componentsConfig = createComponents({
	...
	CheckboxIndicator: customCheckboxIndicator,
});
