...
import CheckConnection from "../src/utils/CheckConnection.js";
...
function Loader(props) {
  ...
  const {
    queryInfo = {},
    showSuccessMsg,
    apiLoadingInfo: loading_api,
    apiErrorInfo: error_api,
    children,
  } = props;
  ...
  useEffect(() => {
    const errorInfo = !(isNil(error_graphQL) || !error_graphQL)
      ? error_graphQL
      : error_api;
    if (errorInfo) {
