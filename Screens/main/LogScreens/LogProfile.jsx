  ...
  const handleOnSave = async () => {
    ...
    try {
      ...
      if (finishUpdatingLogProfile) {
        console.log(
          "finishUpdatingLogProfile for logprofile",
          finishUpdatingLogProfile
        );
        console.log(
          "finishUpdatingLogProfile.updateUser.user[0].logProfile",
          finishUpdatingLogProfile.updateUser.user[0].logProfile
        );
        AppStore.setLogProfile(
          finishUpdatingLogProfile.updateUser.user[0].logProfile
        );
        if (caseLogFormToGet) {
                            ...
                            <SelectPortal>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem
                                  ...
                                  value="WestEndMedical"
                                />
                                <SelectItem
                                  label="Lakeside Clinic"
                                  value="LakesideClinic"
                                />
                                <SelectItem
                                  label="Mountain View"
                                  value="MountainView"
                                      ...
                                      >
                                        ...
                                        <SelectPortal>
                                          ...
                                          <SelectContent>
                                            ...
                                            <Divider borderWidth={0.1} />
                                            <SelectItem
                                              label="Professor of Medicine"
                                              value="ProfessorOfMedicine"
                                            />
                                            <SelectItem
                                              label="Associate Professor of Surgery"
                                              value="AssociateProfessorOfSurgery"
                                            />
                                            <SelectItem
                                              label="Assistant Professor of Pediatrics"
                                              value="AssistantProfessorOfPediatrics"
                                            />
                                            <SelectItem
                                              label="Chief Medical Officer"
                                              value="ChiefMedicalOfficer"
                                            />
                                            <SelectItem
                                              label="Senior Consultant Cardiologist"
                                              value="SeniorConsultantCardiologist"
                                            />
                                            <SelectItem
                                              label="Consultant Oncologist"
                                              value="ConsultantOncologist"
                                            />
                                            <SelectItem
                                            ...
                                            />
                                            <SelectItem
                                              label="Clinical Instructor in Neurology"
                                              value="ClinicalInstructorInNeurology"
                                            />
                                            <SelectItem
                                              label="Adjunct Professor of Psychiatry"
                                              value="AdjunctProfessorOfPsychiatry"
                                            />
                                            <SelectItem
                                              label="Visiting Professor of Dermatology"
                                              value="VisitingProfessorOfDermatology"
                                            />
                                            <SelectItem
                                              label="Emeritus Professor of Obstetrics"
                                              value="EmeritusProfessorOfObstetrics"
                                            />
                                          </SelectContent>
                                        </SelectPortal>
                                      </Select>
                  ...
                  facultyList.map((faculty, index) => {
                    return (
                      ...
                      >
                        ...
                        <Text width={"$45%"}>{faculty.designation}</Text>
                        {/* <Button
                           width={"$30%"}
                           height={50}
                           size="sm"
                ...
                {rotationList.length === 0 ? (
                  ...
                  rotationList.map((rotation, index) => {
                    ...
                    return (
                      ...
                      >
                        <Text width={"$5%"}>{index + 1}.</Text>
                        <Text width={"$45%"}>{rotation.department}</Text>
                        <VStack width="$45%">
                          <HStack>
                            <VStack>
                              <Box>
