				...
				<Box flex={1} backgroundColor='$primaryBackground' justifyContent='center' alignItems='center'>
					<ScrollView width={"$100%"}>
						<Box width={"$100%"} flex={3 / 4} alignItems='center' paddingTop={20} paddingBottom={20}>
							<VStack space='lg' width={"$100%"} alignItems='center'>
													...
													<Select width={"$100%"} onBlur={onBlur} onValueChange={onChange} selectedValue={value}>
														...
														<SelectPortal>
															...
															<SelectContent>
																...
																<SelectItem label='City General' value='CityGeneral' />
																<SelectItem label='Green Valley' value='GreenValley' />
																<SelectItem label='Saint Mary' value='SaintMary' />
																<SelectItem label='Northside' value='Northside' />
																<SelectItem label='River Hospital' value='RiverHospital' />
																<SelectItem label='Sunnybrook' value='Sunnybrook' />
																<SelectItem label='West End Medical' value='WestEndMedical' />
																<SelectItem label='Lakeside Clinic' value='LakesideClinic' />
																<SelectItem label='Mountain View' value='MountainView' />
															</SelectContent>
														</SelectPortal>
													</Select>
												);
								...
								<Box width={"$90%"}>
									<Button onPress={handleOpenFaculty} ref={ref} alignSelf='flex-start' width={"$50%"} height={50} size='sm' variant='secondary'>
											...
											{modalView === "faculty" ? (
												...
												<>
													...
													<HStack justifyContent='$space-between'>
														...
														<Button w='$50%' size='sm' variant='primary' action='positive' onPress={handleSubmitForRotations(handleSaveRotation)}>
                  ...
                  <Text size="xs" alignSelf="flex-start">
                    Faculty will shortly receive a verification link
								...
								<Box width={"$90%"}>
									<Button onPress={handleOpenRotation} ref={ref} alignSelf='flex-start' width={"$50%"} height={50} size='sm' variant='secondary'>
										<ButtonText color='#1E1E1E' fontFamily='Inter_Bold' textAlign='center'>
											Create Rotation
										</ButtonText>
									</Button>
