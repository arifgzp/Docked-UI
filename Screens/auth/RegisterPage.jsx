...
const RegisterPage = ({ navigation, route }) => {
  ...
  const handleJoining = async () => {
    ...
    if (consecutiveSpecialCharsRegex.test(formData.email)) {
      setEmailError(
        "Email address cannot contain consecutive special characters"
      );
      return;
    }
    ...
    switch (response.status) {
      case "SUCCESS":
        ...
        if (signInResponse) {
          navigation.navigate("Email Sent Page", {
            enteredMail: formData.email,
              ...
              <VStack space="3xl">
                ...
                <Box>
                  <FormControl
                    size="md"
                    isDisabled={false}
                    isInvalid={joinPressed && nameError}
                    isReadOnly={false}
                    isRequired={false}
                  >
                ...
                <Box>
                  <FormControl
                    isInvalid={joinPressed && emailError}
                    size="md"
                    isDisabled={false}
                    isReadOnly={false}
                    isRequired={false}
                ...
                <Box>
                  <FormControl
                    size="md"
                    isDisabled={false}
                    isInvalid={joinPressed && passwordError}
                    isReadOnly={false}
                    isRequired={false}
                  >
                    <Box justifycontent="center" alignItems="center">
                ...
                <Box>
                  <VStack justifycontent="center" alignItems="center">
                    ...
                    <Button
                      variant="link"
                      size="sm"
                      onPress={() => navigation.navigate("Privacy Policy Page")}
                    >
                    ...
                    <Text width={"$80%"} size="xs" textAlign="center">
                      To learn more about how Docked collects, uses, share and
