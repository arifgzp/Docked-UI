...
/**
 * AddOrthodonticsClinicalCaseLogPayloadBase
 * auto generated base class for the model AddOrthodonticsClinicalCaseLogPayloadModel.
 */
export const AddOrthodonticsClinicalCaseLogPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('AddOrthodonticsClinicalCaseLogPayload')
  .props({
    __typename: types.optional(types.literal("AddOrthodonticsClinicalCaseLogPayload"), "AddOrthodonticsClinicalCaseLogPayload"),
...
export class AddOrthodonticsClinicalCaseLogPayloadModelSelector extends QueryBuilder {
...
export function selectFromAddOrthodonticsClinicalCaseLogPayload() {
  return new AddOrthodonticsClinicalCaseLogPayloadModelSelector()
}

export const addOrthodonticsClinicalCaseLogPayloadModelPrimitives = selectFromAddOrthodonticsClinicalCaseLogPayload().numUids
