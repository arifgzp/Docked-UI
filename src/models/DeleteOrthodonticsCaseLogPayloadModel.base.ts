...
/**
 * DeleteOrthodonticsCaseLogPayloadBase
 * auto generated base class for the model DeleteOrthodonticsCaseLogPayloadModel.
 */
export const DeleteOrthodonticsCaseLogPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('DeleteOrthodonticsCaseLogPayload')
  .props({
    __typename: types.optional(types.literal("DeleteOrthodonticsCaseLogPayload"), "DeleteOrthodonticsCaseLogPayload"),
...
export class DeleteOrthodonticsCaseLogPayloadModelSelector extends QueryBuilder {
...
export function selectFromDeleteOrthodonticsCaseLogPayload() {
  return new DeleteOrthodonticsCaseLogPayloadModelSelector()
}

export const deleteOrthodonticsCaseLogPayloadModelPrimitives = selectFromDeleteOrthodonticsCaseLogPayload().msg.numUids
