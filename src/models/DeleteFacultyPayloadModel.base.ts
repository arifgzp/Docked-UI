...
/**
 * DeleteFacultyPayloadBase
 * auto generated base class for the model DeleteFacultyPayloadModel.
 */
export const DeleteFacultyPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('DeleteFacultyPayload')
  .props({
    __typename: types.optional(types.literal("DeleteFacultyPayload"), "DeleteFacultyPayload"),
...
export class DeleteFacultyPayloadModelSelector extends QueryBuilder {
...
export function selectFromDeleteFacultyPayload() {
  return new DeleteFacultyPayloadModelSelector()
}

export const deleteFacultyPayloadModelPrimitives = selectFromDeleteFacultyPayload().msg.numUids
