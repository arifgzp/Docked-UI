...
/**
 * ThesisCaseBase
 * auto generated base class for the model ThesisCaseModel.
 */
export const ThesisCaseModelBase = withTypedRefs<Refs>()(ModelBase
  .named('ThesisCase')
  .props({
    __typename: types.optional(types.literal("ThesisCase"), "ThesisCase"),
    id: types.identifier,
...
export class ThesisCaseModelSelector extends QueryBuilder {
...
export function selectFromThesisCase() {
  return new ThesisCaseModelSelector()
}

export const thesisCaseModelPrimitives = selectFromThesisCase().caseName.createdOn.updatedOn
