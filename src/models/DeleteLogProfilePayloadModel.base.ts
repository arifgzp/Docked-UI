...
/**
 * DeleteLogProfilePayloadBase
 * auto generated base class for the model DeleteLogProfilePayloadModel.
 */
export const DeleteLogProfilePayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('DeleteLogProfilePayload')
  .props({
    __typename: types.optional(types.literal("DeleteLogProfilePayload"), "DeleteLogProfilePayload"),
...
export class DeleteLogProfilePayloadModelSelector extends QueryBuilder {
...
export function selectFromDeleteLogProfilePayload() {
  return new DeleteLogProfilePayloadModelSelector()
}

export const deleteLogProfilePayloadModelPrimitives = selectFromDeleteLogProfilePayload().msg.numUids
