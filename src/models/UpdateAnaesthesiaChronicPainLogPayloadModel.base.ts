...
/**
 * UpdateAnaesthesiaChronicPainLogPayloadBase
 * auto generated base class for the model UpdateAnaesthesiaChronicPainLogPayloadModel.
 */
export const UpdateAnaesthesiaChronicPainLogPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('UpdateAnaesthesiaChronicPainLogPayload')
  .props({
    __typename: types.optional(types.literal("UpdateAnaesthesiaChronicPainLogPayload"), "UpdateAnaesthesiaChronicPainLogPayload"),
...
export class UpdateAnaesthesiaChronicPainLogPayloadModelSelector extends QueryBuilder {
...
export function selectFromUpdateAnaesthesiaChronicPainLogPayload() {
  return new UpdateAnaesthesiaChronicPainLogPayloadModelSelector()
}

export const updateAnaesthesiaChronicPainLogPayloadModelPrimitives = selectFromUpdateAnaesthesiaChronicPainLogPayload().numUids
