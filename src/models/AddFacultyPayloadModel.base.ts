...
/**
 * AddFacultyPayloadBase
 * auto generated base class for the model AddFacultyPayloadModel.
 */
export const AddFacultyPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('AddFacultyPayload')
  .props({
    __typename: types.optional(types.literal("AddFacultyPayload"), "AddFacultyPayload"),
...
export class AddFacultyPayloadModelSelector extends QueryBuilder {
...
export function selectFromAddFacultyPayload() {
  return new AddFacultyPayloadModelSelector()
}

export const addFacultyPayloadModelPrimitives = selectFromAddFacultyPayload().numUids
