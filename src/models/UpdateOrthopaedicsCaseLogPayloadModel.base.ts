...
/**
 * UpdateOrthopaedicsCaseLogPayloadBase
 * auto generated base class for the model UpdateOrthopaedicsCaseLogPayloadModel.
 */
export const UpdateOrthopaedicsCaseLogPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('UpdateOrthopaedicsCaseLogPayload')
  .props({
    __typename: types.optional(types.literal("UpdateOrthopaedicsCaseLogPayload"), "UpdateOrthopaedicsCaseLogPayload"),
...
export class UpdateOrthopaedicsCaseLogPayloadModelSelector extends QueryBuilder {
...
export function selectFromUpdateOrthopaedicsCaseLogPayload() {
  return new UpdateOrthopaedicsCaseLogPayloadModelSelector()
}

export const updateOrthopaedicsCaseLogPayloadModelPrimitives = selectFromUpdateOrthopaedicsCaseLogPayload().numUids
