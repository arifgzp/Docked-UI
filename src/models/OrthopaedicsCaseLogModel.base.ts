...
export const orthopaedicsCaseLogModelPrimitives = selectFromOrthopaedicsCaseLog().createdOn.updatedOn.date.hospital.faculty.patientAge.patientSex.rotation.diseaseCategory.site.joint.bones.outcomes.diagnosis.caseType
