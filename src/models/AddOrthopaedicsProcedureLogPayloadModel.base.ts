...
/**
 * AddOrthopaedicsProcedureLogPayloadBase
 * auto generated base class for the model AddOrthopaedicsProcedureLogPayloadModel.
 */
export const AddOrthopaedicsProcedureLogPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('AddOrthopaedicsProcedureLogPayload')
  .props({
    __typename: types.optional(types.literal("AddOrthopaedicsProcedureLogPayload"), "AddOrthopaedicsProcedureLogPayload"),
...
export class AddOrthopaedicsProcedureLogPayloadModelSelector extends QueryBuilder {
...
export function selectFromAddOrthopaedicsProcedureLogPayload() {
  return new AddOrthopaedicsProcedureLogPayloadModelSelector()
}

export const addOrthopaedicsProcedureLogPayloadModelPrimitives = selectFromAddOrthopaedicsProcedureLogPayload().numUids
